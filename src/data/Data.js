...
export const projectsData = [
  {
    ...
    description: 'A full-CRUD web application built using Python, JavaScript, Django, PostgreSQL, and Materialize UI.',
  ...
  },
  {
    ...
    image: Project3,
    name: 'Travel Moire',
    description: 'A Full-stack web application built using React, Javascript, HTML, CSS, and backend with full-CRUD using Express, Mongoose and MongoDB.',
    category: 'Web Development',
  ...
  },
  {
    ...
    image: Project6,
    name: 'PomoTom',
    description: 'A full-CRUD web application built using React, JavaScript, HTML5, CSS3, Express, MongoDB, Express.js, Material UI, and RESTful Routing.',
    category: 'Web Development',
